            ...
            {[
              {
                ...
                value: getValueFromResponse("totalProperties", 0), 
                key: "totalProperties",
                icon: "total_applied",
              ...
              {
                label: t("APPROVED"), 
                value: getValueFromResponse("totalPropertiesApproved", 0), 
              ...
              {
                label: t("SENDBACK"), 
                value: getValueFromResponse("totalPropertiesSentBack", 0), 
              ...
              {
                label: t("REJECTED"), 
                value: getValueFromResponse("totalPropertiesRejected", 0), 
            ...
            {[
              {
                ...
                text: t("NEWWATERAPPLICATIONFORM"),
                link: "/digit-ui/employee/ws/new-application",
              },
              {
                image: "trackApplication",
                text: t("TRACKAPPLICATION"),
                link: "/digit-ui/employee/ws/application-search",
              },
              {
                image: "duplicateReceipt",
                text: t("DUPLICATERECEIT"),
                link: "/digit-ui/employee/ws/application-search",
              },
              {
                image: "deleteReceipt",
                text: t("DELETEERECEIT"),
                link: "/digit-ui/employee/ws/application-search",
              },
              {
                image: "noDuesApply",
