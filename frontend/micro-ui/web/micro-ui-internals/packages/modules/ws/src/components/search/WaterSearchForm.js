        ...
        <div className="page-content-wrapper">
          ...
          <div>
            ...
            <div className="form-field">
                <label className="form-label">New Customer ID /Appliction ID</label>
                <input
                  className="form-input"
                  type="text"
                  placeholder="Enter Customer/Appliction ID"
                  value={formValue.applicationNumber}
                  //disabled
                  {...register("applicationNumber")}
                   onChange={(e) => {
                    setValue("applicationNumber", e.target.value);
                  }}
                />
              </div>
              ...
              {/* Customer ID */}
              <div className="form-field">
                <label className="form-label">Old Customer ID</label>
                <input
                  className="form-input"
                  type="text"
            ...
            <div className="submitted-data-section">
              ...
              <div className="submitted-data-grid">
                <div className="submitted-data-item">
                  <div className="submitted-data-label">qppliction ID</div>
                  <div className="submitted-data-value">
                    {submittedData.applicationNumber || <span className="submitted-data-empty">Not provided</span>}
                  </div>
                </div>
                <div className="submitted-data-item">
                  <div className="submitted-data-label">CustomerId ID</div>
                  <div className="submitted-data-value">
                    {submittedData.customerIds || <span className="submitted-data-empty">Not provided</span>}
                  </div>
                </div>
                <div className="submitted-data-item">
                  <div className="submitted-data-label">Property ID</div>
                  <div className="submitted-data-value">
                    {submittedData.PropertyId || <span className="submitted-data-empty">Not provided</span>}
                  </div>
                </div>
                <div className="submitted-data-item">
