        ...
        mutationUpdate.mutate(payload, {
            onSuccess: (data) => {
                ...
                if (WaterConnection) {
                    //const flag = true;
                    history.push({
                        pathname: `/digit-ui/employee/ws/application-details/${WaterConnection.applicationNo}`,
                    ...
                    // window.location.href = `/digit-ui/employee/ws/application-details/${WaterConnection.applicationNo}`;
