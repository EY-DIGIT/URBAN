...
const Response = () => {
    ...
    const connNumber = state?.data?.applicationNo
    ...
    return <div>
        {/* {isLoading || isLoadingAppDetails ? <Loader/> :  */}
        <Card>
            <Banner
            ...
            {/* {(isSuccess || "WS_AP/1013/2025-26/000095") && !isError && (<div className="primary-label-btn d-grid" style={{ marginLeft: "unset", marginBottom: "10px", padding: "0px 8px" }} onClick={handleDownloadPdf}>
                  <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginTop:"3px"}}>
                    <path d="M17 5H3C1.34 5 0 6.34 0 8V14H4V18H16V14H20V8C20 6.34 18.66 5 17 5ZM14 16H6V11H14V16ZM17 9C16.45 9 16 8.55 16 8C16 7.45 16.45 7 17 7C17.55 7 18 7.45 18 8C18 8.55 17.55 9 17 9ZM16 0H4V4H16V0Z" fill="#6B133F" />
                  </svg>
