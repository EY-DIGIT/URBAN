...
const ApplicantDocumentsSection = () => {
  ...
  const documentSections = [
    {
      id: 'passport_photo',
      title: 'Passport Size Photo of Applicant',
      required: true,
      description: 'JPG, PNG, SVG or PDF, file size no more than 25MB'
    },
    {
      id: 'govt_id',
      title: 'Govt. ID Proof (Aadhaar, PAN, Driving License)',
      required: true,
      description: 'JPG, PNG, SVG or PDF, file size no more than 25MB'
    },
    {
      id: 'shop_photo',
      title: 'Photograph of the Shop',
      required: true,
      description: 'JPG, PNG, SVG or PDF, file size no more than 25MB'
    },
    {
      id: 'property_tax',
      title: 'Property Tax Paid Receipt (For Current Financial Year)',
      required: true,
      description: 'JPG, PNG, SVG or PDF, file size no more than 25MB'
    },
    {
      id: 'rent_agreement',
      title: 'Rent Agreement (If Applicant is Tenant - Mandatory)',
      required: false,
      description: 'JPG, PNG, SVG or PDF, file size no more than 25MB'
    },
    {
      id: 'consent_letter',
      title: 'Notarised Consent Letter From Property Owner (Property Tax Receipt Not in Owner Name - Mandatory)',
      required: false,
      description: 'JPG, PNG, SVG or PDF, file size no more than 25MB'
    }
  ];
