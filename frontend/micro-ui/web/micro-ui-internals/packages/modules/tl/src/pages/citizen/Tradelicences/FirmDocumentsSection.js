...
const FirmDocumentsSection = () => {
  const [selectedType, setSelectedType] = useState("Private Limited Company");
  const [uploadedFiles, setUploadedFiles] = useState({});
  const [isMobile, setIsMobile] = useState(window.innerWidth <= 768);

  const companyTypes = [
    { code: "private_limited", name: "Private Limited Company" },
    { code: "public_limited", name: "Public Limited Company" },
  ];
  ...
  const documentSections = [
    {
      ...
      title: 'Memorandum of Association & Authority Letter from Company Director',
      required: true,
  ...
  return (
    ...
    <div className="form-section" style={styles.formSection}>
        ...
        <div style={styles.flex30}>
            ...
            <Dropdown
              option={[
                { code: "private limited", value: "Private Limited Company" },
                { code: "public limited", value: "Public Limited Company" }
              ]}
              optionKey="code"
              t={(key) => key}
              selected=""
...
export default FirmDocumentsSection;