...
const FirmDocumentsSection = () => {
  ...
  const companyTypes = [
    { code: "bravery_doc", name: "Bravery Document" },
    { code: "sport_doc", name: "Sport Document" },
  ];
  ...
  const documentSections = [
    {
      ...
      title: 'Medical Council Issued Degree/ Certificate for the business',
      required: true,
  ...
  return (
    ...
    <div className="form-section" style={styles.formSection}>
        ...
        <div style={styles.flex30}>
            ...
            <Dropdown
              option={[
                { code: "Bravery Doc", name: "Bravery Document" },
                { code: "Sport Doc", name: "Sport Document" },
              ]}
              optionKey="code"
              t={(key) => key}
              selected=""
