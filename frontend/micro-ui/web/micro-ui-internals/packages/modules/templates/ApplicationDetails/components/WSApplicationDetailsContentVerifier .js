...
function ApplicationDetailsContentVerifier({
  ...
  const owner = application?.property?.owners?.[0] || {};
  const address = application?.property?.address || {};
  ...
  const items = [
    {
      ...
      content:
        <div >
          ...
          {(application?.connectionHolders || []).map((owner, index) => (
            <React.Fragment key={index}>
              ...
              <div style={{ ...styles.grid, marginTop: "20px" }}>
                ...
                <div style={styles.flex30}>
                  ...
                  <input style={styles.input} value={owner.guardian} disabled readOnly />
                </div>
                ...
                <div style={styles.flex30}>
                  ...
                  <input style={styles.input}
                    ...
                    value={
                      owner?.identityType
                        ? owner.identityType.identityNumber.replace(/\d(?=\d{4})/g, "X")
                        : "N/A"
                    }
                    disabled readOnly
                  />
    ...
    {
      title: <div ><h3 style={{ color: "#6B133F", fontWeight: "700" }}>Connection Address</h3></div>,
      content:
        <div >
          {/* <div style={styles.sectionTitle}>Connection Address</div> */}
          <div style={styles.grid}>
    ...
    {
      title: <div ><h3 style={{ color: "#6B133F", fontWeight: "700" }}>Water Details</h3></div>,
      content:
        <div >
          {/* Section Header */}
          <div>
          ...
          <div style={styles.grid}>
            <div style={styles.flex30} >
              {/* Exemption Dropdown */}
              <label style={styles.label}>Uses Type.</label>
               <input style={styles.input} value={application?.usageType} disabled readOnly />
              {/* <select style={styles.input} value={application?.usageType} disabled>
                <option>{owner?.ownerType}</option>
              </select> */}
            </div>
            <div style={styles.flex30}>
              <label style={styles.label}>Water Connection Type</label>
              <input style={styles.input} value={application?.usageSubType} disabled readOnly />
            </div>
            <div style={styles.flex30}>
          ...
          <div style={{ display: "flex", gap: "20px", marginTop: "12px", marginBottom: "24px" }}>
            <label style={styles.checkboxLabel}>
              <input type="checkbox" checked={application?.connectionType} disabled readOnly />
              <span style={{ marginLeft: "8px" }}>{application?.connectionType ==="FLAT"?"Flat":"Metered"} </span>
            </label>
            {/* <label style={styles.checkboxLabel}>
