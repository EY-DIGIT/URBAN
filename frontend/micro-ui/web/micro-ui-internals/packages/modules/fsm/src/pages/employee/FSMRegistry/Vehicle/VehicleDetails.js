                      ...
                      return value?.type === "custom" ? (
                        <>
                          <div className={`${index === detail?.values?.length - 1 ? "row last" : "row"} border-none`}>
                            <h2>{t(value.title)}</h2>
                            <div className="value" style={{ color: "#6B133F", display: "flex" }}>
                              {t(value.value) || "N/A"}
                              {value.value === "ES_FSM_REGISTRY_DETAILS_ADD_VENDOR" && (
                                <span onClick={() => onActionSelect("ADD_VENDOR")}>
                                  <AddIcon className="" fill="#6B133F" styles={{ cursor: "pointer", marginLeft: "20px", height: "24px" }} />
                                </span>
                              )}
                              {value.value != "ES_FSM_REGISTRY_DETAILS_ADD_VENDOR" && (
                              ...
                              {value.value != "ES_FSM_REGISTRY_DETAILS_ADD_VENDOR" && (
                                <span onClick={() => onActionSelect("DELETE_VENDOR")}>
                                  <DeleteIcon className="delete" fill="#6B133F" style={{ cursor: "pointer", marginLeft: "20px" }} />
                                </span>
                              )}
                            </div>
                          </div>
