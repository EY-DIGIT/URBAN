...
const AttachmentsSection = () => {
  ...
  const handleConfirm = () => {
    ...
    history.push("/digit-ui/citizen/tl/tradelicence/birthcertificate-success");
  };
  ...
  const documentSections = [
    {
      id: 'aadhaar_front',
      title: 'Relative’s/Reporters Aadhaar Card (Front)',
      required: true,
      description: 'JPG, PNG, SVG or PDF, file size no more than 25MB'
    },
    {
      id: 'aadhar_back',
      title: 'Relative’s/Reporters Aadhaar Card (Back) *',
      required: true,
      description: 'JPG, PNG, SVG or PDF, file size no more than 25MB'
    },
    {
  ...
  return (
    ...
    <div className="form-section" style={styles.formSection}>
      ...
      <div style={{ 
        ...
        <button
          type="button"
          onClick={() => console.log('Send Back clicked')}
          style={{
            backgroundColor: 'rgb(107, 19, 63)',
            color: 'white',
            border: 'none',
