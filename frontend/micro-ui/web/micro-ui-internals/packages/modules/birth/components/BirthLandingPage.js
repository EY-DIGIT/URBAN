            ...
            {[
              {
                ...
                label: "Total Applied", 
                value: getValueFromResponse("totalProperties", 20), 
                key: "totalProperties",
                icon: "total_applied",
              ...
              {
                //label: t("CREATED"), 
                label: <Fragment>Pending with <br/> Ward Officer</Fragment>,
                value: getValueFromResponse("totalPropertiesCreated", 3), 
              ...
              {
                //label: t("FORWARDED"), 
                label: <Fragment>Pending with <br/> Zone Officer</Fragment>,
                value: getValueFromResponse("totalPropertiesForwarded", 5), 
              ...
              {
                //label: t("SENDBACK"), 
                label: <Fragment>Sent Back to <br/> Citizen</Fragment>,
                value: getValueFromResponse("totalPropertiesSentBack", 3), 
              ...
              },
              {
                //label: t("APPROVED"), 
                label: "Approved", 
                value: getValueFromResponse("totalPropertiesApproved", 3), 
              ...
              {
                label: "Rejected",
                value: getValueFromResponse("totalPropertiesRejected", 6),
