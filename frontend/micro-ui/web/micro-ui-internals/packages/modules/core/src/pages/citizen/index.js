...
const Home = ({
  ...
  return (
    <div className={classname}>
      ...
      <div className={window.location.pathname == "/digit-ui/citizen/login" ? "" : `main center-container citizen-home-container`} style={{backgroundColor: "#F3F2F7", justifyContent: "flex-start"}}>
        {hideSidebar ? null : (
