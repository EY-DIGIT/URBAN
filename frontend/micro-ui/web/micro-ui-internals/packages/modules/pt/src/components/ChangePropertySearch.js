...
import PTinboxTable from "./changeInboxTable";
                                            ...
                                            searchResults.length > 0 ? (
                                                searchResults.map((result, index) => (
                                                    <tr key={index}>
                                                       ...
                                                       <td>
                                                            <span className="link">
                                                                <Link to={`/digit-ui/employee/pt/modify-application/${result.propertyId}`}>
...
//                 <div>
//                   <span className="link">
//                     <Link to={`/digit-ui/employee/pt/applicationsearch/ChangePropertyApplicationDetails/${row.original["propertyId"]}`}>
