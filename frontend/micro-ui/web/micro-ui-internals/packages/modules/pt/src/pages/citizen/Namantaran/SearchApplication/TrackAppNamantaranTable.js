                                            ...
                                            searchResults.length > 0 ? (
                                                searchResults.map((result, index) => (
                                                    <tr key={index}>
                                                        <td>
                                                            <span className="link">
                                                                 <Link to={`/digit-ui/citizen/pt/property/application/${result.propertyId}/mp.indore`}>
                                            ...
                                            data && data.length > 0 ? (
                                                data.map((item, index) => (
                                                    <tr key={index}>
                                                        <td>
                                                            <span className="link">
                                                                <Link to={`/digit-ui/citizen/pt/property/application/${item.propertyId}/mp.indore`}>
                                                                    {item.acknowldgementNumber || item.applicationNo}
                                                                </Link>
                                                                {/* {item.acknowldgementNumber || item.applicationNo} */}
                                                            </span>
                                                        ...
                                                        <td>
                                                            ...
                                                            {item.status === "ACTIVE" ? (
                                                <a
                                                    href={`/digit-ui/citizen/pt/property/application/${item.propertyId}/mp.indore`}
                                                    style={{ color: "#1d70b8", textDecoration: "underline", cursor: "pointer" }}
                                                >
                                                    {item?.propertyId}
                                                </a>
